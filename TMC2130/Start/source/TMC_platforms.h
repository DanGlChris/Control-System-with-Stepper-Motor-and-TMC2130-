...
#else // DUE:116kHz
  #define writeMOSI_H digitalWrite(mosi_pin, 1)
  #define writeMOSI_L digitalWrite(mosi_pin, 0)
  #define writeSCK_H digitalWrite(sck_pin, 1)
  #define writeSCK_L digitalWrite(sck_pin, 0)
  #define readMISO digitalRead(miso_pin)
#endif
