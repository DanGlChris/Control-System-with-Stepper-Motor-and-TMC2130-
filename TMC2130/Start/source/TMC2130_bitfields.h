...
struct GCONF_t {
  ...
  union {
    uint32_t sr : 18;
    struct {
      bool  i_scale_analog : 1, // 2130
            internal_rsense : 1, // 2130
            en_pwm_mode : 1,
            enc_commutation : 1, // 2130
            shaft : 1,
            diag0_error : 1,
            diag0_otpw : 1,
            diag0_stall : 1,
  ...
  union {
    ...
    struct {
      uint8_t ihold : 5, // Standstill current (0=1/32…31=32/32)
                    : 3, //000
              irun : 5, // Motor run current (0=1/32…31=32/32
                   : 3, //000
              iholddelay : 4;
    };
  };
...
struct MSCURACT_t{
  ...
  union{
    uint8_t sr : 25;
    struct{
      uint16_t cur_b : 9, //0...255
                    : 7;
      uint16_t cur_a : 9; //0...255
    };
  };
};
